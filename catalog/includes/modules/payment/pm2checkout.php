...
class pm2checkout {
  ...
  */   
  function install() {
    ...
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Checkout Display', 'MODULE_PAYMENT_2CHECKOUT_DIRECT', 'Direct', 'Checkout Display', '6', '0', 'tep_cfg_select_option(array(\'Direct\', \'Dynamic\'), ', now())");
